...
<script type="text/javascript">
    ...
    function recalcular_total_final(){
        total = 0;
        if($('#TareaspresupuestoclientesOtrosservicioDesplazamiento').length != 0 ){
            total += parseFloat($('#TareaspresupuestoclientesOtrosservicioDesplazamiento').val());
        }
        if($('#TareaspresupuestoclientesOtrosservicioKilometraje').length != 0 ){
            total += parseFloat($('#TareaspresupuestoclientesOtrosservicioManoobradesplazamiento').val());
            total += parseFloat($('#TareaspresupuestoclientesOtrosservicioKilometraje').val());
        }
        total += parseFloat($('#TareaspresupuestoclientesOtrosservicioDietas').val());
        total += parseFloat($('#TareaspresupuestoclientesOtrosservicioVarios').val());
        $('#TareaspresupuestoclientesOtrosservicioTotal').val(total);
    }
