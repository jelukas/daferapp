<div class="pedidosclientes">
    ...
    <fieldset>
        ...
        <?php echo $this->Form->input('presupuestoscliente_id', array('label' => false,'type' => 'hidden','value'=>$presupuestoscliente['Presupuestoscliente']['id'])); ?>
        <?php echo $this->Form->input('tiposiva_id', array('label' => false,'type' => 'hidden','value'=>$presupuestoscliente['Presupuestoscliente']['tiposiva_id'])); ?>
        <table class="edit">
            <tr>
                                ...
                                <table>
                                    ...
                                    <?php foreach ($tarea['Manodeobra'] as $manodeobra): ?>
                                        <tr>
                                            ...
                                            <td class="actions"><?php echo $this->Form->input('Tareaspresupuestocliente.' . $i . '.Manodeobra.' . $j . '.id', array('class' => 'childcheckbox', 'label' => '', 'type' => 'checkbox', 'checked' => true, 'value' => $manodeobra['id'])) ?></td>
                                        </tr>
                                        <?php $j++ ?>
                                    <?php endforeach; ?>
                                </table>
