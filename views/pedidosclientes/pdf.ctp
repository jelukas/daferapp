...
$html .='<tr>';
$html .='<td><p>'.$pedido['Avisosrepuesto']['Cliente']['nombre'].'</p>';
$html .='<p>Cif: '.$pedido['Avisosrepuesto']['Cliente']['cif'].'</p></td>';
$html .='</tr>';
$html .='</table>';
...
$html .='<table border="1" align="center">';
$html .='<tr>';
$html .='<td>Orden: '.$pedido['PresupuestosCliente']['ordene_id'].'</td>';
$html .='</tr>';
$html .='</table>';
...
$html .='<tr>';
$html .='<td>';
$html .='Pedido núm: '.$pedido['Pedidoscliente']['id'];
$html .='</td>';
$html .='</tr>';
$html .='<tr>';
...
$html .='<th>Importe</th>';
$html .='</tr>';
$articulos=$pedido['Avisosrepuesto']['Articulo'];
$baseimponible=0;
...
$tcpdf->Output("Pedido.pdf","I"); //Muestra el pdf
