...
<?php echo $form->create('Cliente');?>
	<fieldset>
 		<legend><?php __('Añadir Cliente');?></legend>
	<?php
		...
		echo $form->input('imprimirconreferencias',array('label' => __('Imprimir con referencias',true)));
		echo $form->input('enviarcorreoe',array('label' => __('Enviar por correo electrónico',true)));
	?>
	</fieldset>
