...
$html .='<tr>';
$html .='<td><p>'.$pedido['Proveedore']['nombre'].'</p>';
$html .='<p>Cif: '.$pedido['Proveedore']['cif'].'</p></td>';
$html .='</tr>';
$html .='</table>';
...
$html .='<table border="1" align="center">';
$html .='<tr>';
$html .='<td>Almacén: '.$pedido['Almacene']['nombre'].'</td>';
$html .='</tr>';
$html .='</table>';
...
$html .='<tr>';
$html .='<td>';
$html .='Pedido núm: '.$pedido['Pedidosproveedore']['id'];
$html .='</td>';
$html .='</tr>';
$html .='<tr>';
