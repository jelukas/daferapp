...
<!-- Albaran -->
    <div style="border: 1px solid black;">
       <b>Observaciones:</b> <?php echo $presupuesto['Presupuestosproveedore']['observaciones'] ?>
    </div>
       <?php if (!empty($tareas)): ?>
    ...
    ?>
<!-- FIN alabaran -->
<!--<p style="text-align: center; font-size: 25px;">DOY MICONFORMIDAD A LA REPARACIÓN Y AL IMPORTE FACTURADO RECIBIENDO LA MAQUINA A MI ENTERA SATISFACIÓN:  SI    NO <br/>
   FIRMA DEL CLIENTE
</p>
...
<div style="font-size: 39px;">
    <table>
        <tr>
            <td>Morón de La Frontera a <?php echo $presupuesto['Presupuestosproveedore']['fechaplazo']; ?></td>
            <td>Base Imponible <?php echo $base_imponible ?> €<br/>
                Impuestos  18 % <?php echo $iva ?> €<br/>
                TOTAL PRESUPUESTO   <?php echo $base_imponible+$iva; ?> €
            </td>
        </tr>
    </table>
</div>
