<div class="proveedores">
    ...
    <fieldset>
        <legend>
            <?php __('Editar Proveedor'); ?>
            <?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $this->Form->value('Proveedore.id')), array('class' => 'button_link')); ?>
            <?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Proveedore.id')), array('class' => 'button_link'), sprintf(__('Seguro que quieres borrar el proveedore # %s?', true), $this->Form->value('Proveedore.nombre'))); ?>
