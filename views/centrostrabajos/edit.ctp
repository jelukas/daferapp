...
<?php echo $this->Form->create('Centrostrabajo');?>
	<fieldset>
 		<legend><?php __('Editar Centro de Trabajo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Centrostrabajo.id')), null, sprintf(__('¿Está seguro que desea eliminarD # %s?', true), $this->Form->value('Centrostrabajo.id'))); ?></li>
