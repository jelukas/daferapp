...
<fieldset>
    <legend><?php __('Añadir Otros servicios a la Tarea del Pedido de Venta'); ?></legend>
    <?php
    echo $this->Form->input('tareasalbaranescliente_id', array('type' => 'hidden', 'value' => $tarea_id));
