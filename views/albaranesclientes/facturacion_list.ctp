    ...
    <?php foreach ($cliente_list as $cliente): ?>
        ...
        <?php if ($cliente['Cliente']['modo_facturacion'] == 'centrotrabajo'): ?>
            <?php foreach ($cliente['Centrostrabajo'] as $centrostrabajo): ?>
                <?php if (!empty($centrostrabajo['Albaranescliente'])): ?>
                    <h4>Posible Factura: <?php echo $centrostrabajo['centrotrabajo'];
                $factura_index++ ?> - <?php echo $centrostrabajo['direccion'] ?> - Id: <?php echo $centrostrabajo['id'] ?></h4>
                    <table class="index">
                        <tr>
                            <th>Numero</th>
                            <th>Fecha</th>
                ...
                <?php foreach ($centrostrabajo['Albaranescliente'] as $albaran): ?>
                            <tr>
                                <td><?php echo $this->Html->link($albaran['Albaranescliente']['numeroalbaran'], array('controller' => 'albaranesclientes', 'action' => 'view', $albaran['Albaranescliente']['id'])) ?></td>
                                <td><?php echo $albaran['Albaranescliente']['fecha'] ?></td>
                                <td><?php echo $albaran['Albaranescliente']['pedidoscliente_id'] ?></td>
                                <td><?php echo $albaran['Albaranescliente']['ordene_id'] ?></td>
        ...
        <?php elseif ($cliente['Cliente']['modo_facturacion'] == 'maquina'): ?>
            <?php foreach ($cliente['Centrostrabajo'] as $centrostrabajo): ?>
                ...
                <?php if (!empty($maquina['Albaranescliente'])): ?>
                        <h4>Posible Factura: <?php echo $maquina['nombre'];
                    $factura_index++; ?> -- Id: <?php echo $maquina['id'] ?></h4>
                        <table class="index">
                            <tr>
                                <th>Numero</th>
                                <th>Fecha</th>
        ...
        <?php if (!empty($cliente['Cliente']['Albaranescliente'])): ?>
            <?php foreach ($cliente['Cliente']['Albaranescliente'] as $albaran): ?>
                    <h4>Posible Factura: <?php echo $albaran['Albaranescliente']['numeroalbaran'];
                $factura_index++; ?> -- Id: <?php echo $albaran['Albaranescliente']['id'] ?></h4>
                    <table class="index">
                        <tr>
                            <th>Numero</th>
                            <th>Fecha</th>
