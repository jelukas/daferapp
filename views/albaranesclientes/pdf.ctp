...
<?php $albaran_total_manoobra = 0 ; $albaran_total_materiales = 0 ; $kilometros = 0; $preciodesplazamiento = 0; $dietas = 0;?>
<!-- Albaran -->
            ...
            <?php if (isset($tarea['Tarea'])): ?>
                <div>
                    ...
                    <?php if (isset($tarea["Partestallere"])): ?>
                        <?php $subtotal_albaran = 0; ?>
                        <?php $subtotal_mano_obra = 0; ?>
                        <table class="partes">
                            <!-- PARTES TALLERES -->
                            <?php foreach ($tarea['Partestallere'] as $partestallere): ?>
                                <?php if (isset($partestallere)): ?>
                                    ...
                                    $subtotal_albaran = $subtotal_albaran + $importe;
                                    ?>
                                        ...
                                        <?php if (!empty($partestallere['Articulo'])): ?>
                                            <table>
                                                ...
                                                <?php foreach ($partestallere['Articulo'] as $articulo): ?>
                                                    ...
                                                    $subtotal_mano_obra = $subtotal_mano_obra + $importe;
                                                    ?> 
                                                    <tr>
                            ...
                            <tr><td colspan="4" style="text-align: right;font-weight: bold;">Subtotal Mano de Obra</td><td style="text-align: right;"><?php echo $subtotal_albaran ?></td></tr>
                            <tr><td colspan="4" style="text-align: right;font-weight: bold;">Subtotal Materiales</td><td style="text-align: right;"><?php echo $subtotal_mano_obra ?></td></tr>
                        </table>
...
<div style="font-size: 39px;">
    <table>
        <tr>
            <td>Morón de La Frontera a <?php echo $albaran['Albaranescliente']['fecha'] ?></td>
