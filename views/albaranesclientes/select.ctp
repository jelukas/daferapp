<div id="AlbaranesclienteSelectDiv">
<?php
foreach ($albaranesclientes as $albaran) 
{
    echo '<h3>Albarán número: ' . $albaran['numeroalbaran'] . '</h3>';
?>
        <fieldset id="add_articulo">
            ...
            <div>  
                ...
                <input type="hidden" class="id_albaran" value="<?php echo $albaran['id']; ?>"/>
            </div>
            <div>
