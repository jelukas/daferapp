...
<style>
    ...
    div#datos_proveedor {border: 1px solid black;}
    div#datos_albaran {border: 1px solid black;}
    div#totales_albaran {border: 1px solid black;}
</style>
<?php if (isset($albaran['Pedidosproveedore']['id'])): ?>
<div id="datos_proveedor">
<table>
    <tr>
        <td>
            <p><?php echo $albaran['Pedidosproveedore']['Proveedore']['nombre']; ?></p>
            <p>Cif: <?php echo $albaran['Pedidosproveedore']['Proveedore']['cif']; ?></p>
        </td>
    </tr>
</table>  
</div>
...
<div id="datos_albaran">
    <table>
        ...
        <tr>
            <td>Pedido núm: </td>
            <td><?php echo $albaran['Pedidosproveedore']['id'] ?></td>
        </tr>
        <tr>
            <td>Almacén: </td>
            <td><?php echo $albaran['Pedidosproveedore']['Almacene']['nombre'];?></td>
        </tr>
        <?php endif; ?>
        <tr>
            <td>Fecha: </td>
...
$tcpdf->Output("AlbaranProveedores.pdf", "I"); //Muestra el pdf
